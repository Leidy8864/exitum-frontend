            ...
            <Fragment>
                <svg onClick={showTreeContainer} xmlns="http://www.w3.org/2000/svg"  width="279.681" height="541.377" viewBox="0 0 279.681 541.377">
                    ...
                    <linearGradient id="linear-gradient" x1="0.278" y1="0.143" x2="0.684" y2="0.954" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#3369fd" />
                        <stop offset="1" stopColor="#1a357f" />
                    </linearGradient>
                    <linearGradient id="linear-gradient-2" x1="0.067" y1="0.099" x2="1.355" y2="0.48" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#78fff1" stopOpacity="0.361" />
                ...
                <g id="Group_882" data-name="Group 882" transform="translate(-328.025 -241.883)">
                    <g id="Group_683" data-name="Group 683" transform="translate(41 3)">
                        ...
                        <path id="Path_401" data-name="Path 401" d="M-10911.893-8358.65s6.05-16.568,17.211-27.727,27.434-16.916,27.434-16.916" transform="translate(11256.311 8670.93)" fill="none" stroke="#fff" strokeLinecap="round" strokeWidth="8" />
                        <path id="Path_402" data-name="Path 402" d="M-10911.893-8383.826s2.64-7.225,7.506-12.092,11.963-7.375,11.963-7.375" transform="translate(11278.898 8693.286)" fill="none" stroke="#fff" strokeLinecap="round" strokeWidth="8" />
                    ...
                    <g id="Repeat_Grid_17" data-name="Repeat Grid 17" transform="translate(378 679)" clipPath="url(#clip-path)">
                        <g transform="translate(-364 -673)">
                            <g id="Ellipse_392" data-name="Ellipse 392" transform="translate(364 673)" fill="#72de5f" stroke="#2247aa" strokeWidth="1">
                                <circle cx="6.5" cy="6.5" r="6.5" stroke="none" />
                                <circle cx="6.5" cy="6.5" r="6" fill="none" />
                            </g>
                        </g>
                        <g transform="translate(-331 -673)">
                            <g id="Ellipse_392-2" data-name="Ellipse 392" transform="translate(364 673)" fill="#72de5f" stroke="#2247aa" strokeWidth="1">
                                <circle cx="6.5" cy="6.5" r="6.5" stroke="none" />
                                <circle cx="6.5" cy="6.5" r="6" fill="none" />
                            </g>
                        </g>
                        <g transform="translate(-298 -673)">
                            <g id="Ellipse_392-3" data-name="Ellipse 392" transform="translate(364 673)" fill="#72de5f" stroke="#2247aa" strokeWidth="1">
                                <circle cx="6.5" cy="6.5" r="6.5" stroke="none" />
                                <circle cx="6.5" cy="6.5" r="6" fill="none" />
                            </g>
                        </g>
                        <g transform="translate(-265 -673)">
                            <g id="Ellipse_392-4" data-name="Ellipse 392" transform="translate(364 673)" fill="#72de5f" stroke="#2247aa" strokeWidth="1">
                                <circle cx="6.5" cy="6.5" r="6.5" stroke="none" />
                                <circle cx="6.5" cy="6.5" r="6" fill="none" />
                            </g>
                        </g>
                        <g transform="translate(-232 -673)">
                            <g id="Ellipse_392-5" data-name="Ellipse 392" transform="translate(364 673)" fill="#72de5f" stroke="#2247aa" strokeWidth="1">
                                <circle cx="6.5" cy="6.5" r="6.5" stroke="none" />
                                <circle cx="6.5" cy="6.5" r="6" fill="none" />
                            </g>
                        </g>
                        <g transform="translate(-199 -673)">
                            <g id="Ellipse_392-6" data-name="Ellipse 392" transform="translate(364 673)" fill="#72de5f" stroke="#2247aa" strokeWidth="1">
                                <circle cx="6.5" cy="6.5" r="6.5" stroke="none" />
                                <circle cx="6.5" cy="6.5" r="6" fill="none" />
                            </g>
                        </g>
